    ...
    : QWidget(parent)
{
    ...
    help->setObjectName("titlesbar/help");
    help->installEventFilter(this);
    help->setIcon(QPixmap(":/images/titlesbar/help.png"));
    help->setToolTip("Help!");

    helpWidget = new Help;
    connect(help, &QToolButton::clicked, this, &TitleBar::displayHelpDocument);
...
void TitleBar::displayHelpDocument()
{
    if(helpWidget->isHidden())
        helpWidget->show();
    else helpWidget->hide();
}
